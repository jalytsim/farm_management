...
def register_blueprints(app):
        ...
        district, weather, stgl, solar, graph, api_crop ,
          ...
          api_farmer_group,
            ...
            api_qr,api_qr,api_gfw,api_grade,
              ...
              api_user, api_store, api_product, api_dashboard,api_eudr,api_payments,api_features,api_notifications,api_farmreport,
    )
    ...
    blueprints = [
        ...
        api_payments.api_payments_bp,api_features.api_feature_bp,api_notifications.api_notifications_bp,api_farmreport.api_farmreport_bp,
