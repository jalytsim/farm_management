    ...
    if data:
        ...
        for row in data:
            ...
            result.append({
                ...
                'farmergroup_name': m['farmergroup_name'],
                'district_name': m['district_name'],
                'district_region': m['district_region'],
                'crop_name': m['crop_name'],
                'tilled_land_size': m['tilled_land_size'],
                'land_type': m['land_type'],
                'planting_date': m['planting_date'].isoformat() if m['planting_date'] else None,
                'season': m['season'],
                'quality': m['quality'],
                'produce_weight': m['produce_weight'],
                'harvest_date': m['harvest_date'].isoformat() if m['harvest_date'] else None,
                'expected_yield': m['expected_yield'],
                'actual_yield': m['actual_yield'],
